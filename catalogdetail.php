...
// Get fileid from URL and validate it
if (isset($_GET['fileid']) && is_numeric($_GET['fileid'])) {
    $fileid = (int) $_GET['fileid']; // Cast to integer for safety
} else {
    // Redirect or show error if fileid is invalid
    header('location: catalog.php');
    exit("<script>alert('Invalid file ID');</script>");
}
                ...
                <div class="card-body p-4">
                    <div class="text-center">
                        <div class="h1 fw-light">Past question Detail</div>
                            ...
                            <p class="mb-4 text-muted">File code : <?php echo @$file_code;?></p>
...
if(@$status == "1"){
    ...
    echo '<button type="button" id="downloadbtn"  class="btn btn-custom">Download</button>';
}else{
