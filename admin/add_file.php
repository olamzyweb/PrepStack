...
$query = "INSERT INTO files (file_id,file_name,file_category,file_code,amount,file_url,is_paid) VALUES('$fileid','$filename','$filecategory','$filecode','$amount','$file_path','$is_paid')";
    ...
    <div class="col-lg-8">
      <div class="card border-0 rounded-3 shadow-lg">
        <div class="card-body p-4">
          ...
          <a href="index.php"><img width="30" height="30" src="https://img.icons8.com/windows/32/circled-left.png" alt="Back"/></a>
          Logged in as: <?php echo $admin_user;?>
...
<!-- filecategory Input -->
<div class="form-floating mb-3">
  <input class="form-control" id="name" type="text" name="file_category" placeholder="Eg. past question,note " data-sb-validations="required" required/>
  <label for="file_category">File category Eg. past question,note</label>
...
<!-- is paid -->
<div class="form-floating mb-3">
  <select  class="form-control" id="is_paid" name="is_paid" placeholder="is_paid" data-sb-validations="required" required >
    <option value="1">Yes</option>
    <option value="0">No</option>
  </select>
  <!-- <input class="form-control" id="is_paid" type="number" name="is_paid" placeholder="is_paid" data-sb-validations="required" required/> -->
  <label for="is_paid">Is It paid</label>
  <div class="invalid-feedback" data-sb-feedback="name:required"> required.</div>
</div>
